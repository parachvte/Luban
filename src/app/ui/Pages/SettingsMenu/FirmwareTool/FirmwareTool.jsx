...
class FirmwareTool extends PureComponent {
    ...
    componentDidMount() {
        UniApi.Event.on('topbar-menu:firmware-tools.export', this.actions.onClickToBuildAndExport);
    }

    componentWillUnmount() {
        UniApi.Event.off('topbar-menu:firmware-tools.export', this.actions.onClickToBuildAndExport);
    }
