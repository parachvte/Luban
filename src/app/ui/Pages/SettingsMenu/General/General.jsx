...
function General({ state: generalState, actions }) {
    ...
    useEffect(() => {
        function cleanup() {
            UniApi.Event.off('topbar-menu:settings.save', handlers.save);
            UniApi.Event.off('topbar-menu:settings.cancel', handlers.cancel);
        }
        cleanup();
        UniApi.Event.on('topbar-menu:settings.save', handlers.save);
        UniApi.Event.on('topbar-menu:settings.cancel', handlers.cancel);
        return cleanup;
    }, [handlers]);
