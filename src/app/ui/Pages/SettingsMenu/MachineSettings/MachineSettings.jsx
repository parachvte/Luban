...
function MachineSettings() {
    ...
    useEffect(() => {
        function cleanup() {
            UniApi.Event.off('topbar-menu:settings.save', actions.onSave);
            UniApi.Event.off('topbar-menu:settings.cancel', actions.onCancel);
        }
        cleanup();
        UniApi.Event.on('topbar-menu:settings.save', actions.onSave);
        UniApi.Event.on('topbar-menu:settings.cancel', actions.onCancel);
        return cleanup;
    }, [actions]);
